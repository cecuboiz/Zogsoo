...
const translations = {
    ...
    ru: {
        ...
        items: {
            ...
            "Сүүтэй цай": "Чай с молоком", "Үзмэний шүүс": "Изюмный сок",
            "Нийслэл салат": "Салат Оливье", "Өндөгний салат": "Яичный салат", "Луувангийн салат": "Морковный салат", "Байцааны салат": "Капустный салат",
            "Хүрэн манжингийн салат": "Свекольный салат", "Цоо байцааны салат": "Острый капустный салат",
            "Монгол багц": "Монгольский сет", "2 хүний багц": "Набор на 2 человек", "3-4 хүний багц": "Набор на 3-4 человек", "5-6 хүний багц": "Набор на 5-6 человек",
            "7-8 хүний багц": "Набор на 7-8 человек", "8-9 хүний багц": "Набор на 8-9 человек", "9-10 хүний багц": "Набор на 9-10 человек"
        }
    }
};
...
const fullMenuData = [
    ...
    // 2-р хоол (Үндсэн)
    { id: 4, category: "2-р хоол", name: "Махан цуглуулга", price: 23000, image_url: "images/махны цуглуулга.jpeg" },
    ...
    { id: 37, category: "Зууш, Ширхэгийн хоол", name: "Дугуй хуушуур", price: 2300, image_url: "images/Дугуй хуушуур.webp" },
...
function updateCartDisplay() {
    ...
    Object.keys(cart).forEach(id => {
        ...
        if (item) {
            ...
            div.innerHTML = `
                <span>${translatedName} x ${qty}</span>
                <span>${(item.price * qty).toLocaleString()} ${translations[currentLang].currency}</span>
            `;
